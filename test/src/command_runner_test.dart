...
import 'package:prestine_cli/src/command_runner.dart';
...
void main() {
  group('PrestineCliCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late PrestineCliCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = PrestineCliCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = PrestineCliCommandRunner();
